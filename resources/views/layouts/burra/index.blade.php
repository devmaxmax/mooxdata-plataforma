...
<head>
    ...
    <meta name="description" content="Burra comida mexicana">
    <meta name="author" content="MooxData">
    <meta name="version" content="nd.v24">
    <meta name="robots" content="noindex,nofollow">
    <meta name="keywords" content="burra, comida, mexicana">
    ...
    <link href="{{ asset('burra/css/style.css') }}?v={{ time() }}" rel="stylesheet">
...
<body id="page-top" style="">
    ...
    <div id="preguntas_pedido" style="display: none; border-radius: .5rem;" class="">
        ...
        <form onSubmit="finalizar_pedido(); return false;">
            ...
            <p>
                <label id='pregunta_1_label'>Nombre y Apellido(*)</label> <input type="text" value=""
                    id="pregunta_1_respuesta" name="pr_preg1" class="form-control" required placeholder="">
            </p>
        ...
        <div id="carouselExampleControls" class="carousel slide " data-ride="carousel" data-interval="3000"
            ...
            <div class="carousel-inner">
                <div class="carousel-item  active">
                    <img src="{{ asset('burra/images/banner_horizontal.gif') }}" class="d-block w-100"
                        alt="...">
                </div>
            </div>
        </div>
    ...
    <div class="container" style="max-width: 600px;background-color: #FFFFFF !important; padding-top: 10px;">
        <div class="row" id="productos">
            <div class="helper_resumen resumen_titulo col-md-12"
                ...
                <a href="javascript://" onclick="vaciar_pedido();" class="btn btn-link" id="boton_vaciar"
                    style="position:absolute; right:5px; margin-top: -5px;"><i class="fas fa-trash"></i> </a>
                <a href="javascript://" onclick="mostrar_resumen_pedido();" class="btn btn-link"
                    style="position:absolute; left:5px; margin-top: -5px;"><i class="fas fa-arrow-left"></i></a>

                <center>Tu pedido </center>
            </div>
            ...
            <div class="helper_buscador resumen_titulo col-md-12"
                ...
                <a href="javascript://" onclick="mostrar_buscador();" class="btn btn-link"
                    style="position:absolute; left:5px; margin-top: -5px;"><i class="fas fa-arrow-left"></i></a>
                <a href="javascript://" onclick="copiar_busqueda();" class="btn btn-link"
                    style="position:absolute;left: 34px;margin-top: -5px;"><i class="fas fa-copy"></i></a>
                <input type="search" value="" id="input_buscador" name="buscador"
                    class="form-control float-right" style="margin-top:-4px;width: calc(100% - 62px);"
            ...
            @foreach ($categories as $category)
                <div class="col-md-12 category-wrapper">
                    <div class="row">
                        <div class="col-md-12 categoria" data-categoria="{{ $category->id }}"
                            id="categoria_{{ $category->id }}" onclick="mostrar_categoria('{{ $category->id }}');">

                            <div class="categoria-titulo-box">
                                <div class="categoria-titulo " onclick="mostrar_categoria('{{ $category->id }}');">
                                    <a href="javascript://" onclick="mostrar_categoria('{{ $category->id }}');">
                                        @if ($category->image)
                                ...
                                <div class="categoria-titulo-open-close-icon-container">
                                    <i class="fas fa-angle-down icono_{{ $category->id }} categoria_icono"></i>
                                </div>
                            </div>
                        </div>

                        @foreach ($products->where('category_id', $category->id) as $product)
                            <div class="col-md-12 producto" data-categoria="{{ $category->id }}"
                                data-subcategoria="{{ $product->id }}" id="producto_{{ $product->id }}"
                                style="display:none;">
                                <div class="producto_fila producto-box" id="fila_{{ $product->id }}">
                                    ...
                                    <div class="producto_cantidades" id="cantidades_{{ $product->id }}"
                                    ...
                                    <div class="helper_variedades_agregar clearfix"
                                        ...
                                        <button class='btn float-right add-new-option producto-agregar-opcion'
    ...
    <div class="footer-enviar-pedido" style="display:none;pointer-events: none;" id="footer_enviar">
        <a href="javascript://" onclick="clickEnviarPedido()" class="btn animated my-btn-auxiliar" id="boton_enviar"
    ...
    <div class="popup_instagram">
        ...
        <div class="popup_instagram_link">
            <input type="text" readonly value="https://mooxdata.xyz/app/burracomidamexicana"
                id="input_instagram_link" style="width: calc(100% - 50px);margin-right: 10px;" />
    ...
    <div class="navbar-footer-container">
        <div style="" class="navbar-footer">
            ...
            <button class="btn my-btn-primary" id="boton_buscador" style="HCHdisplay:none;" type="button"
                onclick="mostrar_buscador();">
    ...
    <script src="{{ asset('burra/js/app.js') }}?v={{ time() }}"></script>
    ...
    <script>
        function checkOpeningHours() {
            ...
            const cartelCerrado = document.getElementById('popup_control_horario');
            const botonEnviar = document.getElementById('footer_enviar');
            ...
            if (isOpen) {
                ...
                if (cartelCerrado) {
                    ...
                    cartelCerrado.style.transform = 'translate(-50%, -50%)';
                    cartelCerrado.style.zIndex = '9999';
                    cartelCerrado.style.backgroundColor = 'rgba(0,0,0,0.9)';
                    cartelCerrado.style.color = 'white';
